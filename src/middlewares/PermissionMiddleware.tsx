            ...
            <Container maxWidth='sm' sx={{mt:16}}>
                <Box textAlign='center'>
                    ...
                    <Typography variant="h2" sx={{my:2}}>
                        Você ainda não tem permissão para acessar essaa área!
                    </Typography>

                    <Typography color='text.secondary' sx={{mb:4}}>
                        Se você solicitou para a administração, a permissão para cessar essa área, clique no botão abaixo e atualize a página!
                    </Typography>
